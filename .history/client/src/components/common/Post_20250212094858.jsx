...
const Post = ({ post }) => {
	...
	const [likes, setLikes] = useState(post.likes.users || []); 
	  ...
	  const { mutate: likePost, isPending: isLiking } = useMutation({
		mutationFn: async () => {
			try {
				...
				//console.log("liked data",res.data.updatedLikes);
				return data;
			} catch (error) {
	...
	const isLiked = Array.isArray(post.likes.users) && post.likes.users.includes(authUser._id);
