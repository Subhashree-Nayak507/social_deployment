...
import { commentController, CreatePostController, deletePostController,  getAllPostController,  
    getFollowingPostController,  getLikedPostController,  getUserPostController,  likeUnlikeController } 
...
PostRouter.get("/user/:username", protectRoute,getUserPostController);
